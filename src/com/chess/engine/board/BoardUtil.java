...
public class BoardUtil {
    ...
    public static final int NUM_TILES =64;//number of tiles in a chess board
    public static final int NUM_TILES_PER_ROW = 8;//number of tiles in a one chess row
    ...
    //to make an array of tiles in a column
    ...
    //to make an Array of tiles in a row
    ...
    //to decide if coordinate belong to chess board space
